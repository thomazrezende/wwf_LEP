...
// remove duplicates
function sql_clean($tabela, $col1, $col2){
	$extra = '';
	if($col2) $extra = 'AND n1.'.$col2.' = n2.'.$col2;

	$sql = 'DELETE n1 FROM '.$tabela.' n1, '.$tabela.' n2 WHERE n1.id < n2.id AND n1.'.$col1.' = n2.'.$col1.' '.$extra;
	$ok=mysql_query($sql) or die(mysql_error());
