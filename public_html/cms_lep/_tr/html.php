...
function up_file_form($form_id, $input_id, $action, $input_name, $multiple, $drop_area, $formatos, $ajax){
	...
	if($multiple) print  "<input ".$jx." lista=\"".$formatos."\" id=\"input".$input_id."\" type=\"file\" name=\"".$input_name."\" class=\"".$class." multiple\" multiple>\r\n";
	else print  "<input ".$jx." lista=\"".$formatos."\" id=\"input".$input_id."\" type=\"file\" name=\"".$input_name."\" class=\"".$class." single\" >\r\n";
