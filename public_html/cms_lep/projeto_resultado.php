...
<body>
    ...
    <div id="cont">
      	<div id="dados">
			...
			titulo("","&darr; INSERIR IMAGEM (700x250px jpg, gif, png)",false);
			up_file_form("_resultado", "", "php/projeto_resultado_img_up.php?id=".$id, "imagem", false, true, "jpg,jpeg,gif,png,bmp","ajax"); 
